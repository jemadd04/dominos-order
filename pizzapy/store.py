...
class Store(object):
    ...
    def get_menu(self, lang='en'):
        response = request_json(self.urls.menu_url(),
                                store_id=self.id, lang=lang)
...
class StoreLocator(object):
    ...
    def nearby_stores(address, service='Delivery'):
        ...
        """
        data = request_json(address.urls.find_url(
        ), line1=address.line1, line2=address.line2, type=service)
